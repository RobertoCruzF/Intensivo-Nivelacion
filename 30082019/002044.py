...
# ocurre lo mismo que en el caso anterior
# el marker define el tipo de punteado que va a tener el grafico en cada uno de sus puntos
plt.plot(ages_x,py_dev_y,color='#5a7d9a', label="Python") # la letra b define el color de la linea

# lista java script
js_dev_y = [37810, 43515, 46823, 49293, 53437,
            56373, 62375, 66674, 68745, 68746, 74583]

plt.plot(ages_x,js_dev_y,color='#adad3b', label="JavaScript") # la letra b define el color de la linea
