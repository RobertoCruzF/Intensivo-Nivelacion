...
plt.plot(ages_x,dev_y,color='k', linestyle='--',marker='.', label='All Devs') # el k define un color y los guiones que sea una linea segmentada
...
# ocurre lo mismo que en el caso anterior
# el marker define el tipo de punteado que va a tener el grafico en cada uno de sus puntos
plt.plot(ages_x,py_dev_y,color='b',marker='o', label="Python") # la letra b define el color de la linea
